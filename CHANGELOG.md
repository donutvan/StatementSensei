...
- Add venv when running uv
- Remove poetry.lock from Dockerfile
...
- *(docker)* Use uv instead of poetry
- *(deps)* Update monopoly-core to 0.15.0rc2
...
- *(tauri)* Pin monopoly-app cargo version to 0.1.0
- *(build)* Use current tag for generating changelog
- *(build)* Install git cliff separately

### Build

- *(dev-deps)* Add git cliff as build dependency
...
- Improve ui
- Build pyodide wheel
- Remove pyodide files
- Bump monopoly-streamlit to 0.9.2
- Fix wrong license
